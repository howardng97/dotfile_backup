  ...
  config = function()
    ...
    local alpha_c = function()
      ...
      dashboard.section.buttons.val = {
        dashboard.button("CTL n", " Open Dir", ":Neotree right<CR>"),
        dashboard.button("SPC f f", " Find file", ":Telescope find_files<CR>"),
        dashboard.button("CONF", " Neobin config", "<Cmd>Neotree right reveal ~/.config/nvim<CR>"),
        dashboard.button("EXIT", "  Quit", "<Cmd>qa<CR>"),
      }
