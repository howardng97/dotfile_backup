...
-- 				dashboard.button("SPC t b", "󰆼 Open Data Base UI", ":DBUIToggle<CR>"),
-- 				dashboard.button("SPC f f", " Find file", ":Telescope find_files<CR>"),
-- 				dashboard.button("SPC f g", " Live grep", ":Telescope live_grep<CR>"),
-- 				--dashboard.button("CTL n n", " Open Dir", ":Neotree reveal right<CR>"),
-- 				--dashboard.button("SPC s s", " Neobin config", "<Cmd>Neotree reveal right ~/.config/nvim<CR>"),
